...
Begin VB.Form frmSplash 
   ...
   Begin VB.CheckBox chkSounds 
      ...
      Width           =   1455
   End
   Begin CityBuilder.Hyperlink hlWebsite 
      Height          =   195
      Left            =   6570
      TabIndex        =   12
      Top             =   1800
      ...
      _ExtentY        =   344
      Caption         =   "[Website]"
      URL             =   "http://www.geocities.com/farazazhar_net/"
      ToolTipText2    =   "Click Here"
   ...
   Begin VB.Label tmpLabel 
      AutoSize        =   -1  'True
      Caption         =   "Transport Tycoon Duluxe (Chris Saywer, Micropose)"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
